...
#
#  $ bin/test -s Products.caps -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src Products.caps.testing.PRODUCTS_CAPS_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/Products/caps/tests/robot/test_example.robot
#
